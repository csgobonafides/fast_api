...
@pytest.fixture
def test_db(prepare_test_database: str, database: DatabaseConfig, database_name: str) -> DatabaseConnector:
    ...
    print(f"Truncate tables took {datetime.now() - start_time} seconds, truncated tables: {tables}")
