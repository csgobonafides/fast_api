...
def upgrade() -> None:
    ...
    op.add_column(
        "lamp", sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False)
    )
    op.alter_column(
        "lamp",
        "price",
    ...
    op.add_column(
        "manufacturer", sa.Column("name", sa.String(length=200), nullable=False)
    )
    op.add_column(
        "manufacturer",
...
def downgrade() -> None:
    ...
    op.create_unique_constraint(
        "manufacturer_manufacturer_key", "manufacturer", ["manufacturer"]
    )
    op.alter_column(
        "manufacturer",
        "create_at",
